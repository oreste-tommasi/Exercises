...
//	 CGeoTile
// ---------------------------------------------------------------------------
CGeoTile::CGeoTile( CGeoTerrain* inTerrain )
{
	InitCommon();
...
// ---------------------------------------------------------------------------
void
CGeoTile::SetupTile( int inLevel, int posX, int posY, const GeoRect& inR )
{
	mLevel = inLevel;
	mPosId.Set( posX, posY );
	mBounds = inR;
} 
...
// ---------------------------------------------------------------------------
int 
CGeoTile::GetTerrainId() const
{
	return mTerrain->GetId();
}
